...
const FooterLink = ({ href, children }) => (
  <li>
    <a
      href={href}
      className="hover:underline hover:text-BgDarkAccent transition"
    >
      {children}
    </a>
  </li>
    ...
    >
      <div className="container max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          ...
          >
            BioDekho is a contemporary and intuitive matchmaking platform
            dedicated to helping individuals find their life partners. Our
            mission is to make the journey of discovering a soulmate smooth,
        ...
        <div>
          ...
          >
            <IoMdMailOpen /> support@biodekho.com
          </p>
          <div
          ...
          >
            <a
              href="https://www.facebook.com/devmilon923"
              className="hover:text-primary transition"
            >
              Facebook
            </a>
            <a
              href="https://x.com/dev_milon923"
              className="hover:text-primary transition"
            >
              Twitter
            </a>
            <a
              href="https://linkedin.com/in/devmilon"
              className="hover:text-primary transition"
            >
              LinkedIn
            </a>
      ...
      >
        <p>&copy; {new Date().getFullYear()} Biodekho | All rights reserved.</p>
      </div>
    </footer>
  );
};
