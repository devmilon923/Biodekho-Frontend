...
const BdMarriage = () => {
  ...
  return (
    <section
      id="works"
      className={`relative py-10 sm:py-16 lg:py-24 px-6 md:px-0 ${
        isDarkMode
          ? "bg-BgDarkSecondary text-gray-200"
    ...
    >
      <div className="px-4 mx-auto max-w-6xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          <h2
            className={`text-4xl font-extrabold mx-auto md:text-6xl lg:text-5xl ${
          ...
          <p
            className={`max-w-2xl mx-auto mt-4 text-base leading-relaxed md:text-2xl ${
              isDarkMode ? "text-gray-400" : "text-gray-600"
            }`}
          >
            Biodekho makes your journey of finding the perfect life partner easy
            and seamless.
          </p>
        </div>
        ...
        <div className="relative mt-12 lg:mt-20">
          ...
          <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
            <div>
              <div
                className={`flex items-center justify-center w-16 h-16 mx-auto rounded-full shadow ${
                  isDarkMode
