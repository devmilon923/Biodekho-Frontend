...
const BiodataShowcase = () => {
  ...
  return (
    <div
      className={`max-w-7xl mx-auto my-20 px-6 md:px-0 ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {randomBiodatas.map((biodata, index) => (
            <div
              ...
              className={`p-5 rounded-lg border shadow-sm flex flex-col items-center ${
            ...
            >
              ...
              <Link to={`/biodata-details/${biodata.biodataId}`}>
                <button
                  className={`mt-4 px-4 py-2 rounded-md font-semibold text-white bg-custom-gradient`}
                >
                  View Profile
                </button>
              </Link>
