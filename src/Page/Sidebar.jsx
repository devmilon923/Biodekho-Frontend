...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed z-40 w-64 h-screen transform top-0 left-0 transition-transform duration-300 ease-in-out overflow-y-auto bg-gradient-to-t from-red-600 via-rose-500 to-rose-400 text-white ${
